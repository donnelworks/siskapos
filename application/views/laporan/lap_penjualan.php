...
$(document).ready(function(){
  ...
  $('#btnLihat').click(function(e){
    ...
    $('#lapKosong').remove();
    $('#tampilLaporan').html('<iframe class="iframe-rounded" id="laporanPdf" src="<?= site_url("laporan/lap_penjualan/filter_laporan") ?>?'+ params.join("&") +'" frameborder="0" style="width: 100%; height: calc(100vh - 200px)"></iframe>');
